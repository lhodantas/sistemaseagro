...
?>
      ...
      <center><a href='participacao.pdf'  style="padding-bottom: 40px"><button class='btn btn-primary btn-lg'>CERTIFICADOS DE PARTICIPAÇÃO</button></a></center>
      <center><a href='palestrante.pdf'  style="padding-bottom: 40px"><button class='btn btn-primary btn-lg'>CERTIFICADOS PALESTRANTES</button></a></center><br>
    </div>
    <div class="container" >
...
?>
    <div class="container"  style="padding-bottom: 40px">
      <h3 class="text-center" style="padding: 40px 0">CERTIFICADOS</h3>
      <center><a href='participacao.pdf'><button   style="margin-bottom: 25px; width: 50%" class='btn btn-primary btn-lg'>CERTIFICADOS DE PARTICIPAÇÃO</button></a></center>
      <center><a href='palestrante.pdf'><button  style="width: 50%" class='btn btn-primary btn-lg'>CERTIFICADOS PALESTRANTES</button></a></center><br>
    </div>
<?php
    }
?>
